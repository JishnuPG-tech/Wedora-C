        ...
        <div className="glass-card floral-border rounded-[20px] overflow-hidden">
          ...
          >
            <iframe
              ...
              loading="lazy"
            />
              <div className="absolute inset-0 bg-[var(--gold)] opacity-10 pointer-events-none" />
          </Motion.div>
          ...
          <div className="px-6 py-5">
            ...
            >
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-inter uppercase tracking-[0.2em] text-[var(--text-dark)] bg-[var(--pearl-dark)] border border-[var(--gold)]/20">
