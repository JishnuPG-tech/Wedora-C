...
const FamilyCard = ({ side, delay }) => {
  ...
  return (
    ...
    >
      {/* Side accent bar */}
      <div
        className={`absolute top-0 bottom-0 w-[3px] ${isGroom ? 'left-0' : 'right-0'} bg-gradient-to-b from-transparent via-[var(--gold)]/40 to-transparent`}
      />

      <div className="text-center">
        {/* Role label */}
        <p className="font-inter text-[9px] uppercase tracking-[0.35em] text-[var(--gold)] mb-2 opacity-80">
      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div className="h-px flex-1 bg-gradient-to-l from-transparent via-[var(--gold)]/30 to-[var(--gold)]/30" />
          </Motion.div>
